...
class SliverAppBarService {
  ...
  /// Get sample promotions data (only banner promotions)
  static List<PromotionBanner> _getPromotions() {
    ...
    return [
      PromotionBanner(
        id: '1',
        title: 'Jihudumie',
        subtitle: 'Your trusted marketplace for quality products',
        imageUrl: 'assets/promotions/welcome_banner.png',
      ...
      PromotionBanner(
        ...
        subtitle: 'Discover amazing products from verified vendors',
        imageUrl: 'assets/promotions/quality_banner.png',
      ...
      PromotionBanner(
        id: '3',
        title: 'Fast Delivery',
        subtitle: 'Quick and reliable delivery to your doorstep',
        imageUrl: 'assets/promotions/delivery_banner.png',
